...
# 4 "./message_handler.h" 2
# 13 "./message_handler.h"
...
volatile unsigned char led_state = 0, status = e_ind_off;
...
void handle_speed_data(uint8_t *data, uint8_t len)
{
    ...
    data[2] = '\0';
    clcd_print(data, (0x80 + (4)));
}

void handle_gear_data(uint8_t *data, uint8_t len)
{

     clcd_print("GEAR:",(0xC0 + (0)));

    data[2] = '\0';
    clcd_print(data, (0xC0 + (5)));
}
